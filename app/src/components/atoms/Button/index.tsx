...
export type ButtonValiant = 'primary' | 'secondary' | 'danger'
...
export type ButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  ...
  linHeight?: Responsive<LineHeigh>
...
const Button = styled.button<ButtonProps>`
    ...
    ${(props) =>
      toPropValue('letter-spacing', props.letterSpacing, props.theme)}
    ${(props) => toPropValue('line-height', props.height, props.theme)}
