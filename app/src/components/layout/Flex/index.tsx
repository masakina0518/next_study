...
const Flex = styled(Box)<FlexProps>`
    ...
    ${(props) => toPropValue('align-content', props.alignItems, props.theme)}
    ${(props) => toPropValue('justify-content', props.alignItems, props.theme)}
    ${(props) => toPropValue('justify-items', props.alignItems, props.theme)}
